...
function VOXEL_CORE() {
  ...
  PROPS[B.TALLGRASS]     = { name:'Grass',   solid:false,opaque:false,raycast:true, pass:1, model:'cross',rot:'all',topOnly:true, stack:99, hardness:0, type:'grass', boxes:[[0.1,0,0.1,0.9,0.9,0.9]], faces:[T.GRASS_PLANT], desc: '' };
  ...
  PROPS[B.TALL_LOWER]    = { name:'Tall grass', solid:false,opaque:false,raycast:true, pass:1, model:'cross',topOnly:true, noInv:true, stack:99, type:'grass', hardness:0, boxes:[[0.05,0,0.05,0.95,1,0.95]], faces:[T.TALL_BOT], desc: '' };
  PROPS[B.TALL_UPPER]    = { name:'Tall grass', solid:false,opaque:false,raycast:true, pass:1, model:'cross',noInv:true, stack:99, hardness:0, type:'grass', boxes:[[0.05,0,0.05,0.95,1,0.95]], faces:[T.TALL_TOP], desc: '' };
  ...
  PROPS[B.TORCH] = { name:'Torch', solid:false, opaque:false, raycast:true, pass:1, model:'cross', stack:99, hardness:0, light:15, handLight:8, topOnly:true, type:'wood', boxes:[[0.4,0,0.4,0.6,0.7,0.6]], faces:[T.TORCH], desc: '' };
...
const ITEM_PROPS = {
  ...
  [ITEM.GLASS_SHARD]:   { name: 'Glass shard',   stack: 99, icon: 'glass_shard', desc: '' },
  [ITEM.SULFUR]:        { name: 'Sulfur',        stack: 99, icon: 'sulfur', desc: '' },
  [ITEM.CHARCOAL]:      { name: 'Charcoal',      stack: 99, icon: 'charcoal', desc: '' },
  [ITEM.GUNPOWDER]:     { name: 'Gunpowder',     stack: 99, icon: 'gunpowder', desc: '' },
  [ITEM.SUGAR]:         { name: 'Sugar',         stack: 99, icon: 'sugar', desc: '' },
  [ITEM.PAPER]:         { name: 'Paper',         stack: 99, icon: 'paper', desc: '' },
  [ITEM.FLOUR]:         { name: 'Flour',         stack: 99, icon: 'flour', desc: '' },
  [ITEM.BRICK]:         { name: 'Brick',         stack: 99, icon: 'brick', desc: '' },
  [ITEM.GLOW_DUST]:     { name: 'Glow dust',     stack: 99, icon: 'glow_dust', desc: '' },
  [ITEM.STRING]:        { name: 'String',        stack: 99, icon: 'string', desc: '' },
  [ITEM.FEATHER]:       { name: 'Feather',       stack: 99, icon: 'feather', desc: '' },
// ores
  [ITEM.COAL]:          { name: 'Coal',          stack: 99, icon: 'coal', desc: '' },
  [ITEM.COAL_CHUNK]:    { name: 'Coal chunk',    stack: 99, icon: 'coal_chunk', desc: '' },
  [ITEM.RAW_IRON]:      { name: 'Raw iron',      stack: 99, icon: 'raw_iron', desc: '' },
  [ITEM.IRON_INGOT]:    { name: 'Iron ingot',    stack: 99, icon: 'iron_ingot', desc: '' },
  [ITEM.IRON_NUGGET]:   { name: 'Iron nugget',   stack: 99, icon: 'iron_nugget', desc: '' },
  [ITEM.RAW_COPPER]:    { name: 'Raw copper',    stack: 99, icon: 'raw_copper', desc: '' },
  [ITEM.COPPER_INGOT]:  { name: 'Copper ingot',  stack: 99, icon: 'copper_ingot', desc: '' },
  [ITEM.COPPER_NUGGET]: { name: 'Copper nugget', stack: 99, icon: 'copper_nugget', desc: '' },
  [ITEM.RAW_TIN]:       { name: 'Raw tin',       stack: 99, icon: 'raw_tin', desc: '' },
  [ITEM.TIN_INGOT]:     { name: 'Tin ingot',     stack: 99, icon: 'tin_ingot', desc: '' },
  [ITEM.TIN_NUGGET]:    { name: 'Tin nugget',    stack: 99, icon: 'tin_nugget', desc: '' },
  [ITEM.RAW_IRON]:      { name: 'Raw iron',      stack: 99, icon: 'raw_iron', desc: '' },
  [ITEM.IRON_INGOT]:    { name: 'Iron ingot',    stack: 99, icon: 'iron_ingot', desc: '' },
  [ITEM.IRON_NUGGET]:   { name: 'Iron nugget',   stack: 99, icon: 'iron_nugget', desc: '' },
  [ITEM.RAW_GOLD]:      { name: 'Raw gold',      stack: 99, icon: 'raw_gold', desc: '' },
  [ITEM.GOLD_INGOT]:    { name: 'Gold ingot',    stack: 99, icon: 'gold_ingot', desc: '' },
  [ITEM.GOLD_NUGGET]:   { name: 'Gold nugget',   stack: 99, icon: 'gold_nugget', desc: '' },
  [ITEM.DIAMOND]:       { name: 'Diamond',       stack: 99, icon: 'diamond', desc: '' },
